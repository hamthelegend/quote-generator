...
val QuoteCategory.iconContentDescriptionResourceId
    get() = when (this) {
...
val QuoteCategory.iconContentDescription
    @Composable get() = stringResource(iconContentDescriptionResourceId)